...
export const PRODUCTION_TABLE_TRACE_FIELD_NAME = "traceId";
export const PRODUCTION_TABLE_REQUEST_MESSAGE_FIELD_NAME = "生成消息";
export const PRODUCTION_TABLE_POINT_FIELD_NAME = "扣除积分";
export const PRODUCTION_TABLE_RETURN_POINT_FIELD_NAME = "返还积分";
export const PRODUCTION_TABLE_UPDATE_TIME_FIELD_NAME = "更新时间";
